...
/*
NRF52 PRO MICRO PIN ASSIGNMENT -- do not follow - not updated 
...
#define SX126X_DIO1 (32 + 00)     // P1.00 IRQ
...
#define SX126X_BUSY (0 + 31)     // P0.31
#define SX126X_RESET (0 + 2)     // P0.02
